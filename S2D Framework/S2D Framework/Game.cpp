...
{
	auto block = new Block(new Rect(0.0f, 0.0f, 32, 32), new Vector2(200.0f, 200.0f), false);
	auto block2 = new Block(new Rect(0.0f, 0.0f, 32, 32), new Vector2(200.0f, 250.0f), true);
