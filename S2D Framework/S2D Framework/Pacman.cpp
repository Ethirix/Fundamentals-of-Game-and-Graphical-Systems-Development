...
void Player::LoadContent()
{
	...
	_texture->Load("Textures/Pacman.tga", false);
...
void Player::Draw(int elapsedTime)
{
	...
	stream << "Pacman X: " << _position->X << " Y: " << _position->Y;

	SpriteBatch::BeginDraw(); // Starts Drawing
	SpriteBatch::Draw(_texture, _position, _sourceRect); // Draws Pacman
